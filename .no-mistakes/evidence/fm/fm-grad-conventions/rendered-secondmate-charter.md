...
# Charter
evidence conventions demo domain
...
Nobody reads this chat: the captain and the main firstmate see only what is appended to '/tmp/fm-evconv-yHVIEg/home/state/evconv-charter.status', and a captain-facing sentence that is not appended there has not been sent.
...
Firstmate steers you through durable message files in '/tmp/fm-evconv-yHVIEg/home/state/evconv-charter.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/tmp/fm-evconv-yHVIEg/home/state/evconv-charter.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/tmp/fm-evconv-yHVIEg/home/state/evconv-charter.inbox'/NNN.msg '/tmp/fm-evconv-yHVIEg/home/state/evconv-charter.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.

# Escalation to main firstmate
Handle routine work yourself.
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state} [at=<epoch>]: {one short line}" >> '/tmp/fm-evconv-yHVIEg/home/state/evconv-charter.status'`
