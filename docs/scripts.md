...
| `fm-diff-review.sh`      | Emit a line-anchored hunk coverage skeleton for one PR or task diff, then run the deterministic, LLM-free review assertions over it (docs/deterministic-review.md) |
