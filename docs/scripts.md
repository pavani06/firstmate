...
| [`fm-dod-lib.sh`](../bin/fm-dod-lib.sh) | Own ship/scout worker role scope, ship definitions of done, the no-mistakes `--intent` contract, and the fleet prose-skills line shared by ship, scout, and charter briefs |
